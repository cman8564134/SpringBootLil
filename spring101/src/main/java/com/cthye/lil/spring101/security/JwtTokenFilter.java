package com.cthye.lil.spring101.security;
...
public class JwtTokenFilter extends GenericFilterBean {
    ...
    private CthyeUserDetailsService userDetailsService;

    public JwtTokenFilter(CthyeUserDetailsService userDetailsService) {
     ...
     *
     * @param headerVal authorization bearer token in the header
